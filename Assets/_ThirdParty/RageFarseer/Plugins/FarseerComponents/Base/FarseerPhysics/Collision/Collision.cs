...
namespace FarseerPhysics.Collision
{
    ...
    public struct AABB
    {
        ...
        public bool Contains(ref FVector2 point)
        {
            ...
            if ((point.X > (LowerBound.X + FSSettings.Epsilon) && point.X < (UpperBound.X - FSSettings.Epsilon) &&
                 (point.Y > (LowerBound.Y + FSSettings.Epsilon) && point.Y < (UpperBound.Y - FSSettings.Epsilon))))
            {
                return true;
            }
            return false;
                                       ...
                                       ref Transform xfA, ref Transform xfB)
        {
            ...
            return output.Distance < 10.0f * FSSettings.Epsilon;
        }
        ...
        public bool RayCast(out RayCastOutput output, ref RayCastInput input)
        {
            ...
            float tmin = -FSSettings.MaxFloat;
            float tmax = FSSettings.MaxFloat;
    ...
    {
        public int Count;
        public FVector2[] Normals = new FVector2[FSSettings.MaxPolygonVertices];
        public FVector2[] Vertices = new FVector2[FSSettings.MaxPolygonVertices];
    }
    ...
    public static class Collision
    {
                                                   ...
                                                   CircleShape circleB, ref Transform xfB)
        {
            ...
            int normalIndex = 0;
            float separation = -FSSettings.MaxFloat;
            ...
            if (separation < FSSettings.Epsilon)
            {
                manifold.PointCount = 1;
                                           ...
                                           PolygonShape polyB, ref Transform transformB)
        {
            ...
            int pointCount = 0;
            for (int i = 0; i < FSSettings.MaxManifoldPoints; ++i)
            {
        ...
        public class EPCollider
        {
            ...
            public void Collide(ref Manifold manifold, EdgeShape edgeA, ref Transform xfA, PolygonShape polygonB, ref Transform xfB)
            {
                ...
                _radius = 2.0f * FSSettings.PolygonRadius;
                ...
                if (np < FSSettings.MaxManifoldPoints)
                {
                    return;
                }
            ...
            private EPAxis ComputeEdgeSeparation()
            {
                ...
                axis.Separation = FSSettings.MaxFloat;
            ...
            private EPAxis ComputePolygonSeparation()
            {
                ...
                for (int i = 0; i < _polygonB.Count; ++i)
                {
                    ...
                    {
                        if (FVector2.Dot(n - _upperLimit, _normal) < -FSSettings.AngularSlop)
                        {
                            continue;
                        }
                    }
                    ...
                    {
                        if (FVector2.Dot(n - _lowerLimit, _normal) < -FSSettings.AngularSlop)
                        {
                            continue;
                        }
                    }
                                            ...
                                            PolygonShape poly2, ref Transform xf2)
        {
            ...
            int index = 0;
            float minDot = FSSettings.MaxFloat;
                                               ...
                                               PolygonShape poly2, ref Transform xf2)
        {
            ...
            int edge = 0;
            float maxDot = -FSSettings.MaxFloat;
