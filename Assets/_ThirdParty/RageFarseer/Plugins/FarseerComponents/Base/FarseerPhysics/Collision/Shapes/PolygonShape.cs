...
namespace FarseerPhysics.Collision.Shapes
{
    ...
    public class PolygonShape : Shape
    {
            ...
            : base(density)
        {
            ...
            _radius = FSSettings.PolygonRadius;
            ...
            : base(density)
        {
            ShapeType = ShapeType.Polygon;
            _radius = FSSettings.PolygonRadius;
            Normals = new Vertices(FSSettings.MaxPolygonVertices);
            Vertices = new Vertices(FSSettings.MaxPolygonVertices);
        }
        ...
        {
            Debug.Assert(input.Count >= 3 && input.Count <= FSSettings.MaxPolygonVertices);
            ...
            for (int i = 0; i < Vertices.Count; ++i)
            {
                ...
                Debug.Assert(edge.LengthSquared() > FSSettings.Epsilon * FSSettings.Epsilon);
        ...
        protected override void ComputeProperties()
        {
            ...
            Debug.Assert(area > FSSettings.Epsilon);
        ...
        public override float ComputeSubmergedArea(FVector2 normal, float offset, Transform xf, out FVector2 sc)
        {
            ...
            float[] depths = new float[FSSettings.MaxPolygonVertices];
            int diveCount = 0;
            int intoIndex = -1;
            int outoIndex = -1;
            ...
            for (i = 0; i < Vertices.Count; i++)
            {
                ...
                bool isSubmerged = depths[i] < -FSSettings.Epsilon;
                if (i > 0)
                {
                    if (isSubmerged)
                    {
