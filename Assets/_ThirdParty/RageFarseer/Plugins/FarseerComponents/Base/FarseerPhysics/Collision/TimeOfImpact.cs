...
namespace FarseerPhysics.Collision
{
    ...
    public static class TimeOfImpact
    {
        ...
        public static void CalculateTimeOfImpact(out TOIOutput output, TOIInput input)
        {
            ...
            float target = Math.Max(FSSettings.LinearSlop, totalRadius - 3.0f * FSSettings.LinearSlop);
            const float tolerance = 0.25f * FSSettings.LinearSlop;
            ...
            for (; ; )
            {
                ...
                for (; ; )
                {
                    ...
                    if (pushBackIter == FSSettings.MaxPolygonVertices)
                    {
                        break;
                    }
                }
