...
namespace FarseerPhysics.Dynamics
{
    ...
    public class FSBody : IDisposable
    {
        ...
        public BodyType BodyType
        {
            ...
            set
            {
                ...
                {
                    FSFixture fixture = FixtureList[i];
        ...
        public List<FSFixture> FixtureList { get; internal set; }
        ...
        /// <returns></returns>
        public FSFixture CreateFixture(Shape shape)
        {
            return new FSFixture(this, shape);
        }
        ...
        /// <returns></returns>
        public FSFixture CreateFixture(Shape shape, object userData)
        {
            return new FSFixture(this, shape, userData);
        }
        ...
        public void ResetMassData()
        {
            ...
            foreach (FSFixture f in FixtureList)
            {
				if (f.Shape == null) continue;
        ...
        public void IgnoreCollisionWith(FSBody other)
        {
            for (int i = 0; i < FixtureList.Count; i++)
            {
                FSFixture f = FixtureList[i];
