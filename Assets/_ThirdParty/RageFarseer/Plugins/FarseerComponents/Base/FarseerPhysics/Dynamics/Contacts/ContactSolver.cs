...
namespace FarseerPhysics.Dynamics.Contacts
{
    ...
    {
        public FVector2[] localPoints = new FVector2[FSSettings.MaxManifoldPoints];
    ...
    {
        public VelocityConstraintPoint[] points = new VelocityConstraintPoint[FSSettings.MaxManifoldPoints];
    ...
    public class ContactSolver
    {
        ...
        public void InitializeVelocityConstraints()
        {
            for (int i = 0; i < _count; ++i)
            {
                ...
                for (int j = 0; j < pointCount; ++j)
                {
                    ...
                    if (vRel < -FSSettings.VelocityThreshold)
                    {
        ...
        public bool SolvePositionConstraints()
        {
            ...
            for (int i = 0; i < _count; ++i)
            {
                ...
                for (int j = 0; j < pointCount; ++j)
                {
                    ...
                    float C = MathUtils.Clamp(FSSettings.Baumgarte * (separation + FSSettings.LinearSlop), -FSSettings.MaxLinearCorrection, 0.0f);
            ...
            return minSeparation >= -3.0f * FSSettings.LinearSlop;
        }
        ...
        public bool SolveTOIPositionConstraints(int toiIndexA, int toiIndexB)
        {
            ...
            // We can't expect minSpeparation >= -b2_linearSlop because we don't
            // push the separation above -b2_linearSlop.
            return minSeparation >= -1.5f * FSSettings.LinearSlop;
        }
                    ...
                    case ManifoldType.Circles:
                        {
                            ...
                            if (FVector2.DistanceSquared(pointA, pointB) > FSSettings.Epsilon * FSSettings.Epsilon)
                            {
